package com.example.pert7_sqlite;
...
public class MainUpdel extends AppCompatActivity {
    private com.example.pert7_sqlite.MyDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new com.example.pert7_sqlite.MyDatabase(this);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Snama.equals("")){
                    ...
                    db.UpdateMahasiswa(new com.example.pert7_sqlite.Mahasiswa(Sid, Snama, Skelas));
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                db.DeleteMahasiswa(new com.example.pert7_sqlite.Mahasiswa(Sid, Snama, Skelas));
